...
The package provides two commands, \autodoc:command{\\thisframeLTR} and
...
\autodoc:command{\\bidi-on}, which allow you to trade off bidirectional support for a dubious
increase in speed.
