...
\autodoc:param{src} must be the path to an image file;
you may also give \autodoc:param{height} and/or \autodoc:param{width} parameters
...
\autodoc:code{\\img[src=documentation/gutenberg.png,width=120pt]},
\autodoc:code{\\img[src=documentation/gutenberg.png,height=200pt]}, and
\autodoc:code{\\img[src=documentation/gutenberg.png,width=120pt,height=200pt]}:}
