...
\autodoc:command{\\font:clear-fallbacks}. The parameters to \autodoc:command{\\font:add-fallback}
are the same as the parameters to \autodoc:command{\\font}. So this code:
