...
Loading \autodoc:package{inputfilter} into your class with \autodoc:code{class:loadPackage("inputfilter")}
...
\autodoc:code{packages/chordmode.sil} for a more complete one.
\end{document}
]]}
