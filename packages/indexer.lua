...
as either \autodoc:code{\\indexentry[label=...]} or \autodoc:code{\\indexentry\{...\}} (so
...
Multiple indexes are available and an index can be selected by passing the appropriate
\autodoc:param{index} parameter to \autodoc:command{\\indexentry} and \autodoc:command{\\printindex}.

Classes using the indexer will need to call its exported function \autodoc:function{buildIndex}
