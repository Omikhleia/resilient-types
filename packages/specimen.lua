...
provides a few commands to help create test documents. (The \autodoc:class{fontproof}
...
pangrams for the Latin script. Finally, \autodoc:command{\\set-to-width}\autodoc:code{[width=...]\{...\}}
